...
def bot_repost_track_on_track_page(browser, bot_id, track_id):
    ...
    if bot_already_reposted == True:
        print(f'BOT REPOST TRACK ERROR : Bot {bot_id} has already reposted track {track_id}')
    else:
        ...
        try:
            ...
            if repost_button:
                ...
                print(f'BOT REPOST TRACK ERROR : Bot {bot_id} could not find repost button for track {track_id}')
        except Exception as e:
            print(e)