...
def bot_check_follow_artists(bot_id, artist_id):
    ...
    if bot_all_following:
        ...
        print(f'BOT {bot_id} : could not retrieve list of accounts they follow')
...
def bot_follow_artist_on_artist_page(browser, bot_id, artist_id):
    ...
    if bot_already_followed == True:
        print(f'BOT CHECK ARTIST FOLLOW ERROR : Bot {bot_id} has already followed artist {artist_id}')
    else:
        ...
        try:
            ...
            if follow_button:
                ...
                follow_button.click()
                print(f'BOT FOLLOW ARTIST : Bot {bot_id} has clicked follow button for artist {artist_id}')
                ...
                print(f'BOT FOLLOW ARTIST ERROR : Bot {bot_id} could not find follow button for artist {artist_id}')
        except Exception as e:
