...
def bot_sign_up(bot_data):
    ...
    find_form_field_by_xpath_then_keystroke(browser, sign_up_email_xPath, email, user_name, False)
    # TRY TO FIND CONTINUE BUTTON AND CLICK TO NAVIGATE TO NEXT PAGE, OR HANDLE ERRORS
    find_button_by_xpath_and_click(browser, sign_up_email_continue_xPath, user_name)
    # TRY TO FILL FIRST PASSWORD FIELD OF FORM, OR HANDLE ERRORS
    find_form_field_by_xpath_then_keystroke(browser, sign_up_password_one_xPath, password, user_name, False)
    # TRY TO FILL SECOND PASSWORD FIELD OF FORM, OR HANDLE ERRORS
    find_form_field_by_xpath_then_keystroke(browser, sign_up_password_two_xPath, password, user_name, False)
    ...
    find_button_by_xpath_and_click(browser, sign_up_manual_button_xPath, user_name)
    # TRY TO FILL USERNAME FIELD OF FORM, OR HANDLE ERRORS
    find_form_field_by_xpath_then_keystroke(browser, sign_up_username_xPath, user_name, user_name, False)
    # TRY TO FILL HANDLE FIELD OF FORM, OR HANDLE ERRORS
    find_form_field_by_xpath_then_keystroke(browser, sign_up_handle_xPath, user_name, user_name, False)
    # TRY TO FIND AND CLICK CONTINUE BUTTON, OR HANDLE ERRORS
    find_button_by_xpath_and_click(browser, sign_up_continue_button_xPath, user_name)
    # TRY TO FIND AND CLICK "choose for me" BUTTON, OR HANDLE ERRORS
    find_button_by_xpath_and_click(browser, sign_up_choose_for_me_button_xPath, user_name)
    # TRY TO FIND AND CLICK SUBMIT BUTTON, OR HANDLE ERRORS
    find_button_by_xpath_and_click(browser, sign_up_submit_button_xPath, user_name)
